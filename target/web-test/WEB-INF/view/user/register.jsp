        ...
        <div class="col-md-10 mx-auto col-lg-5">
            <form class="p-4 p-md-5 border rounded-3 bg-light" method="post" action="/users/register">
                <div class="form-floating mb-3">
                    <input name="id" type="text" class="form-control" id="id" placeholder="id" value="">
                ...
                <div class="form-floating mb-3">
                    <input name="passwordverify" type="password" class="form-control" id="passwordverify" placeholder="password verify">
